class Xerox{
    ...
    public Xerox(String modelName, String manufacturer, double printSpeed, double paperCapacity,boolean isColor, boolean isDuplex, String connectivity, double weight,double price, boolean isWireless) {
