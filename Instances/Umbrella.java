...
public Umbrella(String brand, String color, double length, double canopyDiameter, boolean isAutomatic, boolean isWindResistant, String material,double weight, double price, String type) {
